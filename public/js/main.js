var webApp = function() {
    ...
    var uiInit = function() {
        ...
        $('.input-datepicker-close').datepicker().on('changeDate', function(e) {
    ...
    var handleNav = function() {
        ...
        allTopLinks
            .mouseenter(function() {
                $('i', this).addClass('animation-bigEntrance');
            })
            .mouseleave(function() {
                $('i', this).removeClass('animation-bigEntrance');
            });
    ...
    var handleSidebars = function(mode) {
        ...
        if (mode === 'init') {
            ...
            sLScroll.add(sRScroll).slimScroll({
                height: sScrollHeight,
                color: '#fff',
                size: '3px',
                touchScrollStep: 100
            });
            $(window).resize(function() {
                handleSidebars('resize-scroll');
            });
            $(window).bind('orientationchange', handleSidebars('resize-scroll'));

            // Init Left Sidebar
            sLToggle.click(function() {
                handleSidebars('toggle-left');
            });
            $('#sidebar-left')
                .mouseenter(function() {
